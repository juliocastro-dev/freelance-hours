<x-ui.card>
    ...
    <div class="py-4">
        ...
        {{-- Dessa forma estamos paginando as propostas --}}
        {{-- <div class="mt-6">
            {{ $proposals->links() }}
        </div> --}}
        {{-- Dessa forma estamos criando o botão Carregar Mais --}}
        @if ($proposals->hasMorePages())
            <div class="mt-6">
                <button type="button" wire:click="loadMore" class="bg-[#181826] text-white font-bold tracking-wide uppercase px-8 py-3 rounded-[4px]
